package br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user_auth;

import br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user.User;
import br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user.UserService;
import br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user.data.UserEntity;
import br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user_auth.dto.LoginDto;
import br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user_auth.dto.RegisterDto;
import br.com.cesarsicas.spring_movie_flix.SpringMovieFlix.domain.user_auth.dto.TokenJWTDto;
